...
wget -qO /etc/pki/containers/fulcio_v1.crt.pem.new https://tuf-repo-cdn.sigstore.dev/targets/fulcio_v1.crt.pem
wget -qO /etc/pki/containers/rekor.pub.new https://tuf-repo-cdn.sigstore.dev/targets/rekor.pub
